    ...
    <nav>
      <div className='w-full flex bg-[#EDEDED] py-2'>
        ...
        <div className='hidden md:flex items-center gap-8 text-[#7C0A02] font-montserrat text-md mr-10'>
            ...
            <Link to="#" className='hover:text-[#FA8072] transition whitespace-nowrap'>About Us</Link>
            <Link to="#" className='hover:text-[#FA8072] transition whitespace-nowrap'>Products</Link>
            <Link to="#" className='hover:text-[#FA8072] transition whitespace-nowrap'>Contact</Link>
        </div>
      ...
      {isOpen &&(
        <div className='md:hidden flex flex-col bg-[#EDEDED] text-[#7C0A02] px-6 py-4 font-montserrat text-lg'>
            ...
            <Link onClick={()=> setIsOpen(false)} to='/' className='hover:text-[#FA8072]'>About Us</Link>
            <Link onClick={()=> setIsOpen(false)} to='/' className='hover:text-[#FA8072]'>Products</Link>
            <Link onClick={()=> setIsOpen(false)} to='/' className='hover:text-[#FA8072]'>Contact</Link>
        </div>
      )}
    </nav>
    </>
